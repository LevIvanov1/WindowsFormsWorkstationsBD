            ...
            try
            {
                switch (mode)
                {
                    case "Server":
                        ...
                        int newServerId = Convert.ToInt32(DBHelper.ExecuteQuery("SELECT COALESCE(MAX(id), 0) + 1 FROM Servers", false).Rows[0][0]);
                    ...
                    case "Workstation":
                        ...
                        int newWsId = Convert.ToInt32(DBHelper.ExecuteQuery("SELECT COALESCE(MAX(id), 0) + 1 FROM Workstations", false).Rows[0][0]);
                    ...
                    case "Operator":
                        ...
                        int newOpId = Convert.ToInt32(DBHelper.ExecuteQuery("SELECT COALESCE(MAX(id), 0) + 1 FROM Operators", false).Rows[0][0]);
                    ...
                    case "Access":
                        ...
                        int newAccessId = Convert.ToInt32(DBHelper.ExecuteQuery("SELECT COALESCE(MAX(id), 0) + 1 FROM Workstation_Operator", false).Rows[0][0]);
                    ...
                    case "Software":
                        ...
                        int newSoftId = Convert.ToInt32(DBHelper.ExecuteQuery("SELECT COALESCE(MAX(id), 0) + 1 FROM Workstation_Soft", false).Rows[0][0]);
